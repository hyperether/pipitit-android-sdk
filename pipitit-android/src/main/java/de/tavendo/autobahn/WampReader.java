      ...
      try {
         ...
         if (parser.nextToken() == JsonToken.START_ARRAY) {
            ...
            if (parser.nextToken() == JsonToken.VALUE_NUMBER_INT) {
               ...
               if (msgType == WampMessage.MESSAGE_TYPE_CALL_RESULT) {
                  ...
                  if (mCalls.containsKey(callId)) {
                     ...
                     PipititLogger.d(TAG, "WAMP RPC success return for unknown call ID received");
                  }
                  ...
                  if (mCalls.containsKey(callId)) {
                     ...
                     PipititLogger.d(TAG, "WAMP RPC error return for unknown call ID received");
                  }
                  ...
                  if (mSubs.containsKey(topicUri)) {
                     ...
                     PipititLogger.d(TAG, "WAMP event for not-subscribed topic received");
                  }
                  ...
                  PipititLogger.d(TAG, "invalid WAMP message: unrecognized message type");

               }
            } else {

               PipititLogger.d(TAG, "invalid WAMP message: missing message type or message type not an integer");
            }
            ...
            if (parser.nextToken() == JsonToken.END_ARRAY) {
               ...
               PipititLogger.d(TAG, "invalid WAMP message: missing array close or invalid additional args");
            }

         } else {

            PipititLogger.d(TAG, "invalid WAMP message: not an array");
         }
         parser.close();
