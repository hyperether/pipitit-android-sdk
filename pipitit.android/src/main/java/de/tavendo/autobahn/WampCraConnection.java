...
public class WampCraConnection extends WampConnection implements WampCra {
    ...
    public void authenticate(final AuthHandler authHandler, final String authKey,
                             final String authSecret) {
        authenticate(authHandler, authKey, authSecret, null);
    }

    public void authenticate(final AuthHandler authHandler, final String authKey,
                             final String authSecret, Object authExtra) {
        CallHandler callHandler = new CallHandler() {
            ...
            public void onResult(Object challenge) {
                ...
                try {
                    ...
                    PipititLogger.e("WampCraConnection:auth", e.toString());
                }
